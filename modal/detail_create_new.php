                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-progress" role="tabpanel"
                                ...
                                <?php if($config_type=='task'){?>
                                    ...
                                    <small style="top: 40px;" class="position-absolute top-100 start-0 translate-middle btn btn-sm"><strong>Queue</strong><br><?php echo $create_date; ?></small>
                                    ...
                                    <small style="top: 40px;" class="position-absolute top-100 start-25 translate-middle btn btn-sm"><strong>Checking</strong> <br><?php echo $accepted_date; ?></small>
                                    ...
                                    <small style="top: 40px;" class="position-absolute top-100 start-50 translate-middle btn btn-sm"><strong>On-productions</strong> <br><?php echo $job_number; ?></small>
                                    ...
                                    <small style="top: 40px;" class="position-absolute top-100 start-100 translate-middle btn btn-sm"><strong>Approved</strong><br><?php echo $approved_date; ?></small>
                                    </div>
                                <!-- <h6>
