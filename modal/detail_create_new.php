                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-progress" role="tabpanel"
                                ...
                                <?php if($config_type=='task'){?>
                                    ...
                                    <small style="top: 30px;" class="position-absolute top-100 start-0 translate-middle btn btn-sm">Queue<?php echo $accepted_date; ?></small>
                                    ...
                                    <small style="top: 30px;" class="position-absolute top-100 start-25 translate-middle btn btn-sm">Checking<?php echo $accepted_date; ?></small>
