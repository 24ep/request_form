                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-progress" role="tabpanel"
                                ...
                                <?php if($config_type=='task'){?>
                                    ...
                                    <small style="top: 30px;" class="position-absolute top-100 start-20 translate-middle btn btn-sm">Queue<?php echo $accepted_date; ?></small>
                                    ...
                                    <small style="top: 30px;" class="position-absolute top-100 start-20 translate-middle btn btn-sm">Checking<?php echo $accepted_date; ?></small>
                                    ...
                                    <small style="top: 30px;" class="position-absolute top-100 start-50 translate-middle btn btn-sm">On-productions<?php echo $job_number; ?></small>
                                    ...
                                    <small style="top: 30px;" class="position-absolute top-100 start-100 translate-middle btn btn-sm">Approved<?php echo $approved_date; ?></small>
                                    </div>
                                <!-- <h6>
