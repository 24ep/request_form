...
<body>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingThree">
      ...
      <strong style="color:blue"><ion-icon n style="font-size: 25px;margin-top:10px; ame="checkmark-circle-outline"></ion-icon> รายการที่ดำเนินการเสร็จสิ้น 50 อันดับล่าสุด</strong>
      </button>
    </h2>
