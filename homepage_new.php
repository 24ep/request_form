...
if (!$_SESSION["login_csg"]){
    ...
    if($_SESSION['verify_code']=="verified"){
        ...
        Header("Location: https://servicegate.000webhostapp.com/verify?work_email=".$_SESSION['work_email']);
    }
...
<head>
    ...
    <link rel="icon" type="image/ocp"
        href="https://servicegate.000webhostapp.com/image/sg_logo_minimize.ico" />
    <!-- textarray -->
...
<link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Thai&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css"
        href="https://servicegate.000webhostapp.com/css-theam/tree-ticket.css">
    <!-- time ago -->
