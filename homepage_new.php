...
<!-- 
        ...
        <div class="col-10 col_detail_main" style="font-size: 14px;padding: 0px;">
            ...
            <nav class="p-3 bg-white shadow-sm border-bottom">
                ...
                <div class="dropdown">
                <input type=search class="form-control form-control-sm rounded-pill" id="input_search" onchange="search_result(this.id);" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false" style="inline-size: unset;width: 300px;" type="text" placeholder="Search .. " aria-label=".form-control-sm example">    
