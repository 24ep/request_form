...
if (!$_SESSION["login_csg"]){
    ...
    if($_SESSION['verify_code']=="verified"){
        ...
        Header("Location: https://phpstack-1224828-4360872.cloudwaysapps.com/verify?work_email=".$_SESSION['work_email']);
...
<head>
    ...
    <link rel="icon" type="image/ocp"
        ...
        href="https://phpstack-1224828-4360872.cloudwaysapps.com/image/sg_logo_minimize.ico" />
...
<link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Thai&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css"
        ...
        href="https://phpstack-1224828-4360872.cloudwaysapps.com/css-theam/tree-ticket.css">
