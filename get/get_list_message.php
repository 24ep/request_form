<?php
  ...
  $query_tg = "SELECT message_box.id as id, target.target_username as username, target.read as read, target.accepted_date as accepted_date, target.read_date as read_date, target.create_date as create_date, target.update_date as update_date, target.msid as msid, message_box.title as title,message_box.description as description 
