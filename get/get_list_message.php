<?php
 session_start();
  ...
  left join all_in_one_project.message_box as message_box on target.msid = message_box.id where target.target_username = '".$_SESSION["username"]."' ORDER BY message_box.id  DESC " or die("Error:" . mysqli_error($con));
