<?php
  ...
  while($row = mysqli_fetch_array($result)) {
      ...
      if($row["readable"]==0){
        $button_check = "<td style='width: 15%;'><button type='button' class='btn btn-danger btn-sm' data-bs-toggle='modal' data-bs-target='#messagemodel'><ion-icon name='mail-unread-outline'></ion-icon> ตรวจสอบ</button></td>";
        unset($st_font_color);
      }else{
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="messagemodelLabel"><?php echo $row["title"]; ?></h5>
