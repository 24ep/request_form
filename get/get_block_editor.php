...
var editor = new EditorJS({
        ...
        tools: {
            ...
            image: {
                ...
                config: {
                    endpoints: {
                        byFile: '/action/action_endpoint_uploadfiles.php', // Your backend file uploader endpoint
                        byUrl: '/action/action_endpoint_uploadfiles.php', // Your endpoint that provides uploading by Url
                    }
                }
            },
        },
