...
function displayTable($host, $username, $password, $database, $table, $columns,$table_id ) {
    ...
    $con = mysqli_connect($host, $username, $password,$database,"10628") or die("Error: " . mysqli_error($con));
    ...
    while($row = mysqli_fetch_array($result)) {
        ...
        echo "<td><button class='btn btn-dark btn-sm' onclick='table_detail_page(".$row['id'].",&#39;". $row[$column] ."&#39;,&#39;".$table."&#39;,&#39;update&#39;)'>Edit</button></td>";
        echo "</tr>";
    }
