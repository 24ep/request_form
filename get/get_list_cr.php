...
include_once($_SERVER['DOCUMENT_ROOT']."/get/get_function_badge.php");
...
<!-- <li class='row shadow-sm p-2 m-2 rounded bg-white' style='text-align: -webkit-center;align-items: center;'
    onclick="cr_id_toggle(<?php //echo $row['id'];?>) "
     data-card="#detail_cr" data-bs-toggle="offcanvas"
    ...
    <div class="col" style="text-align: -webkit-center;"><small class="timeago" datetime="<?php echo $row['create_date']; ?>"><?php echo $row['create_date']; ?></small> </div>
    ...
    <div class="col" style="text-align: -webkit-center;"><?php echo $row["effective_date"]; ?></div>
    ...
    <div class="col">
            <?php if($_SESSION['display_ticket_detail']<>'popup'){ ?>
            ...
            <?php
                ...
                onclick="call_model_edit_content_request('<?php echo $row['id'];?>')"
