...
where ((tr.batch = 'batch 7' and tr.priority in ('P1','P2','P3','P4','P5','P6','P7','P8')) or (tr.batch = 'batch 1-6' and tr.priority in ('P1','P2','P3','P4'))) and tr.already_qc = 'N' and (tr.check_by ='' or tr.check_by ='".$_SESSION['username']."')
