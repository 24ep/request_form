<?php
   ...
   where ((new_job.participant like '%".$_SESSION["username"]."%' and (action_table = 'add_new_job' or action_table = 'job_cms')) or ( cr.participant like '%".$_SESSION["username"]."%'and action_table = 'content_request')) and log_data.action_by <> '".$_SESSION["username"]."' order by log_data.id DESC limit 15 ";
