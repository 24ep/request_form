      ...
      while($row = mysqli_fetch_array($result)) {
        ...
        while($row_attach = mysqli_fetch_array($result_attach)) {
            if($row_attach['is_image']==1){
                $list_image .= '<a target= "_blank" href="'.$row_attach['file_path'].$row_attach['file_name'].'"><img src="'.$row_attach['file_path'].$row_attach['file_name'].'"  class="img-thumbnail" alt="'.$row_attach['file_name'].'" style="object-fit:cover;width:180px;height:180px;"></a>';
            }else{
