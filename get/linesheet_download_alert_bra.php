...
$sql="SELECT * FROM file_manage WHERE job_number='LACF-INDEX' and file_type='Linesheet' and upload_status='Active'";
 $results = mysqli_query($con,$sql);
    ...
    echo '
    <a style="width: fit-content;" class="nav-link mb-3" type="button" href="https://cdse-commercecontent.com/base/'.$row["file_path"].$row["file_name"].'" >
        <span class="main-manu-nav">'.$row["file_name"].'</span><ion-icon name="cloud-download"></ion-icon>
    </a>
    ';
