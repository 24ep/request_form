...
$sql="SELECT * FROM file_manage WHERE job_number='LACF-INDEX' and file_type='Linesheet' and upload_status='Active'";
 $results = mysqli_query($con,$sql);
    ...
    echo '
    <a style="width: fit-content;" id="nav_linesheet_download" class="nav-link mb-3" type="button" href="https://cdse-commercecontent.com/base/'.$row["file_path"].$row["file_name"].'" >
