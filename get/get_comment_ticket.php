...
get_comment($id);
if($status =='accepted'){
    echo '<small style="text-align: center;color:#b7b5b5;">This ticket had beed accepted. if you have a comment content team also get notification but status will not change to waiting confirm</small>';
}
echo '<script>
