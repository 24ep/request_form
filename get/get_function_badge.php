    ...
    function badge_due_date($date){
        if($date <> null){
          ...
          if($date_wiht_formate_diff==0){
            $ef_badge = '<span class="badge rounded-pill bg-danger " style="margin-left:5px">'.$date.'</span>';
          }elseif($date_wiht_formate_diff==1){
            $ef_badge = '<span class="badge rounded-pill bg-warning text-dark" style="margin-left:5px">'.$date.'</span>';
