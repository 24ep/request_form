...
function get_comment_ms($id){
    ...
    $query = "SELECT * FROM comment WHERE ticket_type = 'message_box' and ticket_id = ".$id." ORDER BY id ASC" or die("Error:" . mysqli_error());
     $result = mysqli_query($con, $query);
      while($row = mysqli_fetch_array($result)) {
        $query_attach = "SELECT * FROM attachment WHERE ticket_type = 'message_box' and ticket_id = ".$row['id']." ORDER BY id ASC" or die("Error:" . mysqli_error());
