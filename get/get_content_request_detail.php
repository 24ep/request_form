    ...
    <div class="modal fade" id="imagemodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        ...
        <div class="col-7" style="border-right:1px solid  #ebedef;padding: 1rem 1rem;">
          ...
          <div class="text-white bg-primary toast align-items-center top-5 start-50 translate-middle-x fade hide" role="alert" aria-atomic="true" data-bs-delay="10000" aria-live="assertive" id="liveToast_cr" style="position: absolute; top: 0; right: 0;margin-top:10px;margin-right:10px">
            <div class="d-flex">
