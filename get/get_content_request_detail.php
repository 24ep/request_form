...
echo "<script>console.log('".$_SESSION["department"]."');</script>";
        if(strpos($_SESSION["department"],"Content")!==false or $_SESSION["department"]==""){
            ...
            <div class="row" >
              ...
              <select class="form-select form-select-sm"  id="cr_edit_case_officer" class="selectpicker" data-live-search="true" name="cr_edit_case_officer" onchange="update_cr_detail('.$id.','.$cr_edit_case_officer.')"  style="border: 0px;font-weight: bold;background-color: transparent;" aria-label=".form-select-lg example">
              '.$username_op .'
              </select>
              </div>
            </div>';
