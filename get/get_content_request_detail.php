  ...
  $project_name = $row_project["project_name"];
    ...
    <div class="modal fade" id="imagemodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        ...
        <button class="badge bg-primary" style="border: solid 1px gainsboro;"id="SaveDetailTicket;display:none"  onclick="SaveDetailTicket('.$id.')"><ion-icon name="save-outline"></ion-icon></ion-icon>Save</button>
