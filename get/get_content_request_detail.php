    ...
    <div class="modal fade" id="imagemodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        ...
        <div class="col-7" style="border-right:1px solid  #ebedef;padding: 1rem 1rem;">
          ...
          <div class="toast align-items-center text-white bg-primary border-0 top-0 end-0" role="alert" data-bs-delay="10000" aria-live="assertive" id="liveToast_cr" aria-atomic="true" style="z-index: 11">
            <div class="d-flex">
