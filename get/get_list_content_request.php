  ...
  //  $result_count = mysqli_query($con, $query_count);
    ...
    echo    '<li class="list-group-item d-flex justify-content-between align-items-start" style="font-size:16px;display: block!important;"   >
                            <div style="margin-left: 10px;margin-top:0px;" >
                                ...
                                <small style="color: #adb5bd;font-size:12px;">'.$count_comment_cr.' Comment <strong> | Create by '.$row["request_by"].'</strong></small> <small class="timeago" datetime="'.$row["create_date"].'"><script>timeago.render("'.$row["create_date"].'")</script></small>    
