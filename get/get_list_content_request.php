...
$_SESSION["status"]=$_POST["status"];
    ...
    if($_SESSION["cr_search_input"]<>""){
      ...
      $cr_status = '(( lower(ticket.title) like lower("%'.$_SESSION["cr_search_input"].'%") or lower(ticket.id) like lower("%'.$_SESSION["cr_search_input"].'%")  or lower(ticket.description) like lower("%'.$_SESSION["cr_search_input"].'%")))';
