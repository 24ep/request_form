   ...
   mysqli_close($con);
    ...
    function list_ts_non_status($filter,$ts_command_limit,$level ){
      ...
      <li class="row shadow-sm rounded md-3 p-2 bg-white position-relative" style="<?php echo  $ri_style ?> " data-bs-toggle="offcanvas"
          ...
          <img  data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo $row["owner"]; ?>"  width="30px" height="30px" src="base/image/user_profile/<?php echo $row["owner"]; ?>.jpg" class="rounded-circle" alt="<?php echo $row["owner"]; ?>"></div>
