...
$query = "SELECT count(*) as count_item FROM add_new_job as anj where (".$filter.")
 and (anj.parent is null  or anj.status = 'none') ORDER BY anj.id DESC LIMIT 30 OFFSET ".$start_item
...
?>
<script>document.getElementById('total_page_nj').innerHTML = "<?php echo $page_count; ?>" </script>
