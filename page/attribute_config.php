...
while($row = mysqli_fetch_array($result)) {
  ...
  <th>
  <button type="button" class="btn btn-dark btn-sm" onclick="attribute_detail_page(&#39;'.$row['id'].'&#39;,&#39;'.$row['attribute_code'].'&#39;);byprass_table_information(&#39;'.$row['table_name'].'&#39;,&#39;update&#39;);"
...
function byprass_table_information(target_tb,target_db,target_prefix){
