...
$query = "SELECT distinct sort_attribute_set,attribute_set,table_name,db_name,primary_key_id,prefix FROM all_in_one_project.job_attribute where allow_display= 1 and table_name in ('account') order by sort_attribute_set" or die("Error:" . mysqli_error($con));
  $result = mysqli_query($con, $query);
  $d_attribute_set="";
  $d_attribute_section="";
  $i=0;
