...
//   const elements = document.querySelectorAll('[id^="no_"]');
  const elements_no = document.querySelectorAll('[id^="no_"]:not([style*="display:block"])');
...
function CheckYesNoElements() {
  ...
  const elements_no = document.querySelectorAll('[id^="no_"]:not([style*="display:block"])');
  const elements_yes = document.querySelectorAll('[id^="yes_"]:not([style*="display:block"])');
  var count_yes = 0;
  var count_no = 0;
