...
<nav class="nav p-2 bg-light shadow" style="border-bottom: 1px solid #e3e3e3;">
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        <li role="presentation"  onclick="get_list_job_on_hand('pending');">
        ...
        <li role="presentation"  onclick="get_list_job_on_hand('inprogress');">
        ...
        <li role="presentation"  onclick="get_list_job_on_hand('waiting');">
            <button class="nav-link nav-task" data-bs-toggle="pill" type="button" role="tab" aria-selected="true">
                Waiting information
                <span id="c_waiting" class="badge text-bg-dark ms-2"></span>
            </button>
        </li>
        <li role="presentation"  onclick="get_list_job_on_hand('waiting for other stage');">
            <button class="nav-link nav-task" data-bs-toggle="pill" type="button" role="tab" aria-selected="true">
                Waiting for other stage
                <span id="c_waiting for other stage" class="badge text-bg-dark ms-2"></span>
            </button>
        </li>
        <li role="presentation" onclick="get_list_job_on_hand('rejected');">
            <button class="nav-link nav-task" data-bs-toggle="pill" type="button" role="tab" aria-selected="true">
                Rejected
