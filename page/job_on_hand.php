...
<nav class="nav p-2 bg-light shadow" style="border-bottom: 1px solid #e3e3e3;">
    ...
    <div class="position-absolute end-0 me-3 mt-1" style="margin-right: 120px!important;">
        <select id="username_on_hand" class="align-self-center m-2" onchange="get_list_job_on_hand('current_status');">
            <?php echo $username_op;?>
        </select>
    </div>
    <div class="position-absolute end-0 me-3 mt-1">
        <select id="role_on_hand" class="align-self-center  m-2" onchange="get_list_job_on_hand('current_status');">
            <?php echo $role_op;?>
        </select>
    </div>
</nav>
...
function call_edit_add_new_panel(id, brand) {
  ...
  new TomSelect("#username_on_hand",{})
  new TomSelect("#role_on_hand",{})
