                    ...
                    <div class="d-flex align-items-start">
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <?php
                                ...
                                while($row = mysqli_fetch_array($result)) {
                                    ...
                                    $bucket  .= '<div class="row"><div style="place-self: center;"class="col-3"><img class="me-2 rounded" src="https://ui-avatars.com/api/?name='.$row['prefix'].'>&background='.str_replace("#","",$row['color_project']).'&color=fff&rounded=false&size=25"></div><div class="col-9">';
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            <?php
                                ...
                                include("../get/get_list_update_content.php?bucket=all");
                                echo'</div>';
                                while($row = mysqli_fetch_array($result)) {
