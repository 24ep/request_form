        ...
        background: #f1f1f1;
            ...
            <div class="row">
              <div class="col">
                    ...
                    <!-- <input type="text" class="form-control col-form-label-sm" value="<?php //include('get_max_job_number.php');get_max_job(); ?>"  maxlength=12 required placeholder="12 Char only" id="job_number" name="job_number"> -->
                     <input type="text" class="form-control form-control-sm" value="AUTO GENERATE"  maxlength=12  disabled placeholder="12 Char only" id="job_number" name="job_number">
              </div>
              <div class="col">
                    <label for="exampleInputEmail1">store</label>
                    <select style="background: #f1f1f1" multiple="multiple" class="multiple-select_adj" required  id="store_adj" name="store_adj[]">
                        <?php echo  $store_op; ?>
                    </select>
              </div>
              <div class="col">
            ...
            <div class="row">
              <div class="col">
                    <label for="exampleInputEmail1">Production Type</label>
                      <select style="background: #f1f1f1" id="production_type_adj" name="production_type_adj" required  class="form-select form-select-sm">
                      		<?php echo $production_type_op; ?>
                      </select>
              </div>
                  <div class="col">
                    <label for="exampleInputEmail1">Department</label>
                      <select style="background: #f1f1f1" id="department_adj"  name="department_adj" required  class="form-select form-select-sm">
              ...
              <div class="col">
                    ...
                    <input type="text" class="form-control form-control-sm" required  placeholder="" id="product_type_adj" name="product_type_adj">
              </div>
            </div>
            <div class="row">
                 <div class="col">
                    <label for="exampleInputEmail1">Launch date</label>
                    <input style="background: #f1f1f1" type="date" class="form-control form-control-sm placeholder=" value="<?php echo str_replace(" ","T",$launch_date); ?>" id="luanch_date_adj" name="luanch_date_adj">
              </div>
              <div class="col">
                    <label for="exampleInputEmail1">Wrong ls from buyer</label>
                    <input type="text" class="form-control form-control-sm" placeholder="" id="wrong_data_linesheet_adj" name="wrong_data_linesheet_adj">
              </div>
              <div class="col">
                    <label for="exampleInputEmail1">SKU</label>
                    <input style="background: #f1f1f1" type="number" class="form-control form-control-sm" value="<?php echo $sku; ?>" required  id="sku_adj" name="sku_adj">
              </div>
              <div class="col">
            ...
            <div class="row">
              ...
              <div class="col-3">
                    ...
                    <input style="background: #f1f1f1" type="text" class="form-control form-control-sm" required value="<?php echo $brand; ?>" placeholder="" id="brand_adj" name="brand_adj">
              </div>
			<div class="col-3">
					<label for="exampleInputEmail1">Product Website</label>
					<select style="background: #f1f1f1" multiple="multiple" class="multiple-select_adj"   id="product_website_adj" name="product_website_adj[]">
              ...
              <div class="row">
               <div class="col-3">
                    ...
                    <input type="number" class="form-control form-control-sm"  placeholder="" id="dulplicate_sku_in_mdc_adj" name="dulplicate_sku_in_mdc_adj">
              </div>
                <div class="col-3">
                    <label for="exampleInputEmail1">Wrong data sku</label>
                    <input type="number" class="form-control form-control-sm" placeholder="" id="wrong_data_sku_adj" name="wrong_data_sku_adj">
              </div>
                  <div class="col-3">
                    <label for="exampleInputEmail1">Receive Ticket date</label>
                    <input style="background: #f1f1f1" type="datetime-local" class="form-control form-control-sm" value="<?php echo str_replace(" ","T",$create_date); ?>" required placeholder="yyyy-MM-dd" id="recive_mail_date_adj" name="recive_mail_date_adj">
              </div>
					<div class="col-3">
						<label for="exampleInputEmail1">Project type</label>
						<select style="background: #f1f1f1" multiple="multiple" class="multiple-select_adj" required id="itemmize_type_adj" name="itemmize_type_adj[]">
             ...
             <div class="row" style="padding-top: 10px;">
                <div class="col">
                    ...
                    <textarea style="background: #f1f1f1" class="form-control form-control-sm" id="remark_adj" name ="remark_adj" rows="3"><?php echo $remark; ?></textarea>
                </div>
             </div>
             <div class="d-grid gap-2 d-md-flex justify-content-md-end">
             <input type="submit" class="btn btn-success"  style="margin-top:20px" id="create_job_manage" name="create_job_manage" Value="Create">                                     
             </div>
