<?php
 ...
 $value_name =  str_replace("anj_edit_","",$value_name);
 ...
 session_start();
	...
	if($query) {
        if($value_name=="sub_department"){
            $con_job_cms= mysqli_connect("service-gate-cds-omni-service-gate.a.aivencloud.com","avnadmin","AVNS_lAORtpjxYyc9Pvhm5O4","all_in_one_project","10628") or die("Error: " . mysqli_error($con_job_cms));
