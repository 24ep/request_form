                                    ...
                                    <nav class="navbar">
                                        <div class="container-fluid p-0">
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                                <input type="checkbox" class="btn-check" id="cb_pj" autocomplete="off" checked>
                                                <label class="btn btn-sm btn-outline-primary" for="cb_pj">Project</label>

                                                <input type="checkbox" class="btn-check" id="cb_da" autocomplete="off" checked>
                                                <label class="btn btn-sm btn-outline-primary" for="cb_da">Data & App-sup</label>

                                                <input type="checkbox" class="btn-check" id="cb_cr" autocomplete="off" checked>
