...
if(substr_count($subject,$separant_value)==5){
    ...
    $attributes = array(
        ...
        "bu"=>$bu,
        "tags"=>"Auto_email_created".$im_from_version,
...
# check subject
$keywords = array("SKU maintenance","SKU maintanance","sku_maintanance","SKU Maintainence","SKU Mainternace","SKU Maintenanc","SKU MAINTANACE"); 
$len = count($keywords);
$i=0;
