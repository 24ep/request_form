...
elseif($job_status_filter == 'Continue' and $approved_editing_status == 'correct' and $transfer_type == 'Data and Photo' and $production_type == 'Resize' and $content_complete_date == null and $retouch_complete_date <> null and $upload_image_date<> null ){ $status =  'Content'; }
